...
- Approval file required: `scenarios/clean_anova_case/human_review_decision.yaml`

## Outcome-Level Recommendations

| Outcome | Decision | Analysis path | Post hoc |
| --- | --- | --- | --- |
| `learning_effectiveness` | `classical_anova_recommended` | `classical_one_way_anova` | `tukey_hsd` |
| `onboarding_confidence` | `classical_anova_recommended` | `classical_one_way_anova` | `tukey_hsd` |
| `training_burden` | `classical_anova_recommended` | `classical_one_way_anova` | `tukey_hsd` |
