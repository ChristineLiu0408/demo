...
| Baseline and focal groups | `pass` | Baseline: No_Tool; focal: Agent_Copilot. | Set valid baseline_condition and focal_condition in analysis_plan.yaml. |
...
| Percent interpretation | `pass` | Core result compares 智能体助手辅助 against 无辅助工具. | Add dynamic percentage interpretation to the core results section. |
...
| Check | Status | Evidence | Action if Failed |
| --- | --- | --- | --- |
| Figure output | `pass` | outputs/evaluation_runs/unequal_variance_case/figure_combined_raincloud.png | Regenerate the combined raincloud figure. |
