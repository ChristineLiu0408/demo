...
| Baseline and focal groups | `pass` | Baseline: Standard_Search; focal: AI_Summary_Interface. | Set valid baseline_condition and focal_condition in analysis_plan.yaml. |
...
| Percent interpretation | `fail` | Core result compares AI摘要界面 against 标准搜索. | Add dynamic percentage interpretation to the core results section. |
| Positive and negative direction wording | `warning` | Core percentage summary distinguishes increase and decrease wording. | Check outcome_directions in analysis_plan.yaml. |
...
| Check | Status | Evidence | Action if Failed |
| --- | --- | --- | --- |
| Figure output | `pass` | outputs/evaluation_runs/non_significant_case/figure_combined_raincloud.png | Regenerate the combined raincloud figure. |
