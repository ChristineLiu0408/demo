...
- Approval file required: `scenarios/non_significant_case/human_review_decision.yaml`

## Outcome-Level Recommendations

| Outcome | Decision | Analysis path | Post hoc |
| --- | --- | --- | --- |
| `search_efficiency` | `classical_anova_recommended` | `classical_one_way_anova` | `tukey_hsd` |
| `decision_confidence` | `classical_anova_recommended` | `classical_one_way_anova` | `tukey_hsd` |
| `perceived_effort` | `classical_anova_recommended` | `classical_one_way_anova` | `tukey_hsd` |
